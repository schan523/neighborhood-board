        ...
        <div id = 'createFeed'>
            <div class= 'social-media-wrapper'>
                <div class = 'social-media-header'>
                    <a href ='#' ><img class = 'imgProfile' src = 'https://www.shutterstock.com/image-vector/vector-flat-illustration-grayscale-avatar-600nw-2281862025.jpg' alt =''/> <span><p class ='username'>Username</p></span></a>
